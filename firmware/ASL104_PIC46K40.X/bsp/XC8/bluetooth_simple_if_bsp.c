...
#define BT_PAD_MIRROR_INACTIVE_STATE	GPIO_HIGH
    ...
    #define BT_LEFT_PAD_INIT()			INLINE_EXPR(TRISEbits.TRISE1 = GPIO_BIT_OUTPUT; ANSELEbits.ANSELE1 = 0; BT_LEFT_PAD_SET(true))
    ...
    #define BT_RIGHT_PAD_INIT()			INLINE_EXPR(TRISCbits.TRISC1 = GPIO_BIT_OUTPUT; ANSELCbits.ANSELC1 = 0; BT_RIGHT_PAD_SET(true))
    ...
    #define BT_CTR_PAD_INIT()			INLINE_EXPR(TRISDbits.TRISD3 = GPIO_BIT_OUTPUT; ANSELDbits.ANSELD3 = 0; BT_CTR_PAD_SET(true))
#else
    #define BT_LEFT_PAD_IS_ACTIVE()		(LATEbits.LE1 == BT_PAD_MIRROR_ACTIVE_STATE)
    #define BT_LEFT_PAD_SET(active)		INLINE_EXPR(LATEbits.LE1 = active ? BT_PAD_MIRROR_ACTIVE_STATE : BT_PAD_MIRROR_INACTIVE_STATE)
    #define BT_LEFT_PAD_TOGGLE()		INLINE_EXPR(BT_LEFT_PAD_SET(BT_LEFT_PAD_IS_ACTIVE() ? false : true))
